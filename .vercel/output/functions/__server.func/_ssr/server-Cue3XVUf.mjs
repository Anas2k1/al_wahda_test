...
import { n as getResponse, r as requestHandler } from "./request-response-BZbMDTcg.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DuiC2wvY.mjs");
