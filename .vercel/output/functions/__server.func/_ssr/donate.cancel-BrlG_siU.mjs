...
import { r as PageShell } from "./PageShell-DYZMqwXo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/donate.cancel-BrlG_siU.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: t("donate.cancel.title")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-5 text-muted-foreground leading-relaxed",
				children: t("donate.cancel.body")
			}),
