...
//#region node_modules/.nitro/vite/services/ssr/assets/forms.functions-DJxaYLAu.js
...
var subscribeNewsletter = createServerFn({ method: "POST" }).inputValidator((data) => newsletterSchema.parse(data)).handler(subscribeNewsletter_createServerFn_handler, async ({ data }) => {
...
var submitVolunteer = createServerFn({ method: "POST" }).inputValidator((data) => volunteerSchema.parse(data)).handler(submitVolunteer_createServerFn_handler, async ({ data }) => {
