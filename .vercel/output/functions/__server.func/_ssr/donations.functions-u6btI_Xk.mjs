...
import { i as createSsrRpc } from "./PageShell-D-r5c41G.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/donations.functions-u6btI_Xk.js
...
var createDonationCheckout = createServerFn({ method: "POST" }).inputValidator((data) => donateSchema.parse(data)).handler(createSsrRpc("df31ee0400172821b07265ec104b0d18c1608928081b06e1bfe6b6d4b117609f"));
//#endregion
