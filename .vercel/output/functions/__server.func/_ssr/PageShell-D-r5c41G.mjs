...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BVuDD6tP.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/PageShell-D-r5c41G.js
...
var subscribeNewsletter = createServerFn({ method: "POST" }).inputValidator((data) => newsletterSchema.parse(data)).handler(createSsrRpc("51247a0dbccffebb42f24ae19a0f421d7a7f362895b051b1ae1e3602a7d8390e"));
...
var submitContact = createServerFn({ method: "POST" }).inputValidator((data) => contactSchema.parse(data)).handler(createSsrRpc("d4c523a48edc5324e844f9a5631e9b3ab50822c1a944414a233a3b7223d652ee"));
...
var submitVolunteer = createServerFn({ method: "POST" }).inputValidator((data) => volunteerSchema.parse(data)).handler(createSsrRpc("3ea0c00e881caa75b04310d927292646378059684f2350521d0d1e9f5ff0f570"));
function SiteFooter() {
	const { t } = useLanguage();
