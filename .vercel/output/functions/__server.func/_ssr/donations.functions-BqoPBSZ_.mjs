...
//#region node_modules/.nitro/vite/services/ssr/assets/donations.functions-BqoPBSZ_.js
...
var createDonationCheckout = createServerFn({ method: "POST" }).validator((data) => donateSchema.parse(data)).handler(createDonationCheckout_createServerFn_handler, async ({ data }) => {
